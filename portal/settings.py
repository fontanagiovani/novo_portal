...
if DEBUG:
    ...
    DEBUG_BEFORE_INSTALLED_APPS = ()

    DEBUG_APPS = (
        'debug_toolbar',
    )

    INSTALLED_APPS = DEBUG_BEFORE_INSTALLED_APPS + INSTALLED_APPS + DEBUG_APPS
else:
    # Add here the production apps
    PRODUCTION_BEFORE_INSTALLED_APPS = ()

    PRODUCTION_APPS = (
        'gunicorn',
    )

    INSTALLED_APPS = PRODUCTION_BEFORE_INSTALLED_APPS + INSTALLED_APPS + PRODUCTION_APPS
