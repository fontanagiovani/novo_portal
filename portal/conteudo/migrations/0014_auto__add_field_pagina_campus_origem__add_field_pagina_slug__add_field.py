...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Pagina.campus_origem'
        db.add_column(u'conteudo_pagina', 'campus_origem',
                      self.gf('django.db.models.fields.CharField')(default='RTR', max_length=250),
                      keep_default=False)

        # Adding field 'Pagina.slug'
        db.add_column(u'conteudo_pagina', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default=1, max_length=250),
                      keep_default=False)

        # Adding field 'Pagina.fonte'
        db.add_column(u'conteudo_pagina', 'fonte',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Pagina.campus_origem'
        db.delete_column(u'conteudo_pagina', 'campus_origem')

        # Deleting field 'Pagina.slug'
        db.delete_column(u'conteudo_pagina', 'slug')

        # Deleting field 'Pagina.fonte'
        db.delete_column(u'conteudo_pagina', 'fonte')
