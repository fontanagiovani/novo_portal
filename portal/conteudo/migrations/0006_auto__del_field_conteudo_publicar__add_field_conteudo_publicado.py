...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Conteudo.publicar'
        db.delete_column(u'conteudo_conteudo', 'publicar')

        # Adding field 'Conteudo.publicado'
        db.add_column(u'conteudo_conteudo', 'publicado',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Conteudo.publicar'
        db.add_column(u'conteudo_conteudo', 'publicar',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Deleting field 'Conteudo.publicado'
        db.delete_column(u'conteudo_conteudo', 'publicado')
    ...
    models = {
        ...
        u'conteudo.licitacao': {
            ...
            'encerrado': ('django.db.models.fields.BooleanField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
