...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Evento.slug'
        db.add_column(u'conteudo_evento', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default=1, max_length=250),
                      keep_default=False)

        # Adding field 'Evento.fonte'
        db.add_column(u'conteudo_evento', 'fonte',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Evento.slug'
        db.delete_column(u'conteudo_evento', 'slug')

        # Deleting field 'Evento.fonte'
        db.delete_column(u'conteudo_evento', 'fonte')
