...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Anexo.descricao'
        db.alter_column(u'conteudo_anexo', 'descricao', self.gf('django.db.models.fields.CharField')(max_length=250))

    def backwards(self, orm):

        # Changing field 'Anexo.descricao'
        db.alter_column(u'conteudo_anexo', 'descricao', self.gf('django.db.models.fields.TextField')())
