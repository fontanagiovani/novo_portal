...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Licitacao.data_publicacao'
        db.alter_column(u'conteudo_licitacao', 'data_publicacao', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'Licitacao.data_publicacao'
        db.alter_column(u'conteudo_licitacao', 'data_publicacao', self.gf('django.db.models.fields.DateField')())
