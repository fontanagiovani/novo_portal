...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field galerias on 'Noticia'
        m2m_table_name = db.shorten_name(u'conteudo_noticia_galerias')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('noticia', models.ForeignKey(orm[u'conteudo.noticia'], null=False)),
            ('galeria', models.ForeignKey(orm[u'conteudo.galeria'], null=False))
        ))
        db.create_unique(m2m_table_name, ['noticia_id', 'galeria_id'])

        # Adding M2M table for field videos on 'Noticia'
        m2m_table_name = db.shorten_name(u'conteudo_noticia_videos')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('noticia', models.ForeignKey(orm[u'conteudo.noticia'], null=False)),
        ...
        m2m_table_name = db.shorten_name(u'conteudo_noticia_tags')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('noticia', models.ForeignKey(orm[u'conteudo.noticia'], null=False)),
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field galerias on 'Noticia'
        db.delete_table(db.shorten_name(u'conteudo_noticia_galerias'))

        # Removing M2M table for field videos on 'Noticia'
        db.delete_table(db.shorten_name(u'conteudo_noticia_videos'))

        # Removing M2M table for field tags on 'Noticia'
        db.delete_table(db.shorten_name(u'conteudo_noticia_tags'))
