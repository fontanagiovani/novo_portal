...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AnexoPagina'
        db.create_table(u'conteudo_anexopagina', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('descricao', self.gf('django.db.models.fields.TextField')()),
            ('arquivo', self.gf('django.db.models.fields.related.ForeignKey')(related_name='anexos_pagina', to=orm['filer.File'])),
            ('pagina', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['conteudo.Pagina'])),
        ))
        db.send_create_signal(u'conteudo', ['AnexoPagina'])


    def backwards(self, orm):
        # Deleting model 'AnexoPagina'
        db.delete_table(u'conteudo_anexopagina')
