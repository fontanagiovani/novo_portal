...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'conteudo_imagemgaleria', (
            ...
            ('imagem', self.gf('django.db.models.fields.related.ForeignKey')(related_name='Imagem Galeria', to=orm['filer.File'])),
    ...
    models = {
        ...
        u'conteudo.imagemgaleria': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'imagem': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'Imagem Galeria'", 'to': u"orm['filer.File']"})
        },
        u'conteudo.noticia': {
