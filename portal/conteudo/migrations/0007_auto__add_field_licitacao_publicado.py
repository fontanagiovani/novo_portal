...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Licitacao.publicado'
        db.add_column(u'conteudo_licitacao', 'publicado',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Licitacao.publicado'
        db.delete_column(u'conteudo_licitacao', 'publicado')
