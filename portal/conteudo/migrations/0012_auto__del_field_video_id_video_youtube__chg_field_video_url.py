...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Video.id_video_youtube'
        db.delete_column(u'conteudo_video', 'id_video_youtube')


        # Changing field 'Video.url'
        db.alter_column(u'conteudo_video', 'url', self.gf('embed_video.fields.EmbedVideoField')(default='https://www.youtube.com/watch?v=GbHBXOqI7hc', max_length=200))

    def backwards(self, orm):
        # Adding field 'Video.id_video_youtube'
        db.add_column(u'conteudo_video', 'id_video_youtube',
                      self.gf('django.db.models.fields.CharField')(default='https://www.youtube.com/watch?v=GbHBXOqI7hc', max_length=250),
                      keep_default=False)


        # Changing field 'Video.url'
        db.alter_column(u'conteudo_video', 'url', self.gf('embed_video.fields.EmbedVideoField')(max_length=200, null=True))
