...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ImagemGaleria.imagem'
        db.alter_column(u'conteudo_imagemgaleria', 'imagem_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.Image']))

        # Changing field 'ImagemGaleria.descricao'
        db.alter_column(u'conteudo_imagemgaleria', 'descricao', self.gf('django.db.models.fields.CharField')(max_length=250))

    def backwards(self, orm):

        # Changing field 'ImagemGaleria.imagem'
        db.alter_column(u'conteudo_imagemgaleria', 'imagem_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.File']))

        # Changing field 'ImagemGaleria.descricao'
        db.alter_column(u'conteudo_imagemgaleria', 'descricao', self.gf('django.db.models.fields.TextField')())
