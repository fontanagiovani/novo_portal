...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Licitacao.encerrado'
        db.add_column(u'conteudo_licitacao', 'encerrado',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Licitacao.encerrado'
        db.delete_column(u'conteudo_licitacao', 'encerrado')
