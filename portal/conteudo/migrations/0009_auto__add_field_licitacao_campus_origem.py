...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Licitacao.campus_origem'
        db.add_column(u'conteudo_licitacao', 'campus_origem',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['core.Campus']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Licitacao.campus_origem'
        db.delete_column(u'conteudo_licitacao', 'campus_origem_id')
