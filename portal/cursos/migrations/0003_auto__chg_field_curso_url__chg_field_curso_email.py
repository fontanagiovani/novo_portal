...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Curso.url'
        db.alter_column(u'cursos_curso', 'url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'Curso.email'
        db.alter_column(u'cursos_curso', 'email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True))

    def backwards(self, orm):

        # Changing field 'Curso.url'
        db.alter_column(u'cursos_curso', 'url', self.gf('django.db.models.fields.URLField')(default=' ', max_length=200))

        # Changing field 'Curso.email'
        db.alter_column(u'cursos_curso', 'email', self.gf('django.db.models.fields.EmailField')(default=' ', max_length=75))
