...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'GrupoCursos.descricao'
        db.delete_column(u'cursos_grupocursos', 'descricao')


    def backwards(self, orm):
        # Adding field 'GrupoCursos.descricao'
        db.add_column(u'cursos_grupocursos', 'descricao',
