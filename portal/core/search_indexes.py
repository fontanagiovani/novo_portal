...
class LicitacaoIndex(indexes.SearchIndex, indexes.Indexable):
    text = indexes.CharField(document=True, use_template=True)
    modalidade = indexes.EdgeNgramField(model_attr='modalidade')
    titulo = indexes.EdgeNgramField(model_attr='titulo')
    situacao = indexes.EdgeNgramField(model_attr='situacao')
    objeto = indexes.EdgeNgramField(model_attr='objeto')
    alteracoes = indexes.EdgeNgramField(model_attr='alteracoes')
    data_publicacao = indexes.CharField(model_attr='data_publicacao')
