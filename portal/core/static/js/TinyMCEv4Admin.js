tinyMCE.init({
    ...
    selector:'textarea',
    plugins: [
        "hr link image charmap paste print preview anchor pagebreak searchreplace visualblocks visualchars code fullscreen",
        "insertdatetime media nonbreaking save table emoticons template textcolor",
    ],
    toolbar1: "undo removeformat blockquote redo subscript superscript | cut copy paste | " +
        "bold italic underline strikethrough | alignleft aligncenter alignright alignjustify " +
        "| bullist numlist outdent indent | link image media | print preview | forecolor backcolor emoticons",
