...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Campus.lft'
        db.delete_column(u'core_campus', u'lft')

        # Deleting field 'Campus.tree_id'
        db.delete_column(u'core_campus', u'tree_id')

        # Deleting field 'Campus.level'
        db.delete_column(u'core_campus', u'level')

        # Deleting field 'Campus.rght'
        db.delete_column(u'core_campus', u'rght')


    def backwards(self, orm):
        # Adding field 'Campus.lft'
        db.add_column(u'core_campus', u'lft',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1, db_index=True),
                      keep_default=False)

        # Adding field 'Campus.tree_id'
        db.add_column(u'core_campus', u'tree_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1, db_index=True),
                      keep_default=False)

        # Adding field 'Campus.level'
        db.add_column(u'core_campus', u'level',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=2, db_index=True),
                      keep_default=False)

        # Adding field 'Campus.rght'
        db.add_column(u'core_campus', u'rght',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1, db_index=True),
                      keep_default=False)
