...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Campus.site'
        db.add_column(u'core_campus', 'site',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=None, to=orm['sites.Site'], unique=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Campus.site'
        db.delete_column(u'core_campus', 'site_id')
