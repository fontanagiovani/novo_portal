...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Campus', fields ['site']
        db.delete_unique(u'core_campus', ['site_id'])


        # Changing field 'Campus.site'
        db.alter_column(u'core_campus', 'site_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sites.Site'], null=True))

    def backwards(self, orm):

        # Changing field 'Campus.site'
        db.alter_column(u'core_campus', 'site_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['sites.Site'], unique=True, null=True))
        # Adding unique constraint on 'Campus', fields ['site']
        db.create_unique(u'core_campus', ['site_id'])
    ...
    models = {
        ...
        u'core.campus': {
            ...
            'site': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['sites.Site']", 'null': 'True'})
        },
        u'core.destino': {
