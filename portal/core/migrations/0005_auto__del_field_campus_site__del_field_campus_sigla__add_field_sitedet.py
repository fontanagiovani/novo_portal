...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Campus.sigla'
        db.delete_column(u'core_campus', 'sigla')

        # Adding field 'SiteDetalhe.campus'
        db.add_column(u'core_sitedetalhe', 'campus',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'core_campus', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['sites.Site'], null=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Campus.sigla'
        raise RuntimeError("Cannot reverse this migration. 'Campus.sigla' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Campus.sigla'
        db.add_column(u'core_campus', 'sigla',
                      self.gf('django.db.models.fields.CharField')(max_length=3),
                      keep_default=False)

        # Deleting field 'SiteDetalhe.campus'
        db.delete_column(u'core_sitedetalhe', 'campus_id')
