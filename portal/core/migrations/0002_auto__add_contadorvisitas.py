...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ContadorVisitas'
        db.create_table(u'core_contadorvisitas', (
            ...
            ('contagem', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
        ))
        db.send_create_signal(u'core', ['ContadorVisitas'])


    def backwards(self, orm):
        # Deleting model 'ContadorVisitas'
        db.delete_table(u'core_contadorvisitas')
    ...
    models = {
        ...
        u'core.contadorvisitas': {
            'Meta': {'ordering': "('-criado_em', '-modificado_em')", 'object_name': 'ContadorVisitas'},
            'contagem': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
