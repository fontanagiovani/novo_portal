...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Campus.parent'
        db.delete_column(u'core_campus', 'parent_id')

        # Deleting field 'Campus.slug'
        db.delete_column(u'core_campus', 'slug')

        # Deleting field 'Menu.slug'
        db.delete_column(u'core_menu', 'slug')


    def backwards(self, orm):
        # Adding field 'Campus.parent'
        db.add_column(u'core_campus', 'parent',
                      self.gf('mptt.fields.TreeForeignKey')(related_name='pai', null=True, to=orm['core.Campus'], blank=True),
                      keep_default=False)

        # Adding field 'Campus.slug'
        db.add_column(u'core_campus', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='', max_length=100, unique=True, blank=True),
                      keep_default=False)

        # Adding field 'Menu.slug'
        db.add_column(u'core_menu', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='', max_length=100, unique=True, blank=True),
                      keep_default=False)
