...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'core_sitedetalhe', (
            ...
            ('destino', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Destino'])),
            ('logo', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.Image'])),
            ('hotsite', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('modal', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('social', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('links_uteis', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('mapa_site', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ...
        db.create_table(u'core_destino', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tipo', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('caminho', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal(u'core', ['Destino'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'core_destino')
    ...
    models = {
        ...
        u'core.destino': {
            ...
            'caminho': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'core.sitedetalhe': {
            ...
            'destino': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Destino']"}),
            'endereco': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'hotsite': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'links_uteis': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'logo': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['filer.Image']"}),
            'mapa_site': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'modal': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'site': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['sites.Site']", 'unique': 'True'}),
            'social': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'})
        },
        u'core.tiposelecao': {
