...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PermissaoPublicacao'
        db.create_table(u'core_permissaopublicacao', (
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'core', ['PermissaoPublicacao'])

        # Adding M2M table for field sites on 'PermissaoPublicacao'
        m2m_table_name = db.shorten_name(u'core_permissaopublicacao_sites')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('permissaopublicacao', models.ForeignKey(orm[u'core.permissaopublicacao'], null=False)),
            ('site', models.ForeignKey(orm[u'sites.site'], null=False))
        ))
        db.create_unique(m2m_table_name, ['permissaopublicacao_id', 'site_id'])


    def backwards(self, orm):
        # Deleting model 'PermissaoPublicacao'
        db.delete_table(u'core_permissaopublicacao')

        # Removing M2M table for field sites on 'PermissaoPublicacao'
        db.delete_table(db.shorten_name(u'core_permissaopublicacao_sites'))
    ...
    models = {
        ...
        u'core.permissaopublicacao': {
            'Meta': {'object_name': 'PermissaoPublicacao'},
