...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Menu.ordem'
        db.add_column(u'core_menu', 'ordem',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=1, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Menu.ordem'
        db.delete_column(u'core_menu', 'ordem')
    ...
    models = {
        u'core.menu': {
            ...
            'ordem': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '1', 'null': 'True', 'blank': 'True'}),
