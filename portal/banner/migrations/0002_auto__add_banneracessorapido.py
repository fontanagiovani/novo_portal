...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'banner_banneracessorapido', (
            ...
            ('midia_image', self.gf('django.db.models.fields.related.ForeignKey')(related_name='midia_ar_banner', to=orm['filer.File'])),
        ))
    ...
    models = {
        ...
        u'banner.banneracessorapido': {
            ...
            'data_publicacao': ('django.db.models.fields.DateTimeField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'midia_image': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'midia_ar_banner'", 'to': u"orm['filer.File']"}),
