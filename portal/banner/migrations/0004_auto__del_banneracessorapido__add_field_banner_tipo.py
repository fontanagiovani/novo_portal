...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Banner.tipo'
        db.add_column(u'banner_banner', 'tipo',
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'banner_banneracessorapido', (
            ...
            ('arquivo', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='banners_ar', to=orm['filer.Image'])),
        ...
        db.delete_column(u'banner_banner', 'tipo')
