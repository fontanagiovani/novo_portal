...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BannerAcessoRapido.url'
        db.alter_column(u'banner_banneracessorapido', 'url', self.gf('django.db.models.fields.URLField')(max_length=200))

    def backwards(self, orm):

        # Changing field 'BannerAcessoRapido.url'
        db.alter_column(u'banner_banneracessorapido', 'url', self.gf('django.db.models.fields.CharField')(max_length=250))
