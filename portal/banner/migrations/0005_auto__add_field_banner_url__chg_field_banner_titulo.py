...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'banner_banner', 'url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200),
                      keep_default=False)


        # Changing field 'Banner.titulo'
        db.alter_column(u'banner_banner', 'titulo', self.gf('django.db.models.fields.CharField')(max_length=250))

    def backwards(self, orm):
        # Deleting field 'Banner.url'
        db.delete_column(u'banner_banner', 'url')


        # Changing field 'Banner.titulo'
        db.alter_column(u'banner_banner', 'titulo', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))
